...
.modal-body {
  line-height: 1.6;
      ...
      {/* Trigger Link */}
      <Link to="#"className=" link-info opacity-50 fw-bolder" onClick={handleShow}>
      ...
      <Modal show={show} onHide={handleClose} size="lg" centered>
        <Modal.Header closeButton>
          <Modal.Title>Terms and Conditions for Digital Development Services for Recruiting</Modal.Title>
        </Modal.Header>
        <Modal.Body>
