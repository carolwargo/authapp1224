 ...
 *   <MDBRow className="form-text-header-black d-flex align-items-center mb-3">
                        ...
                        <p className='fw-bold' style={{fontSize:'12px'}}>
                                        ...
                                        <b ><Link to="/infolayout/athletic" className=" link-primary text-decoration-none">3- ATHLETICS</Link></b> 
                                </span>
                                        <span className="fw-bold form-text-header-black" style={{marginLeft:'10px'}}> 
                                 <b ><Link to="/infolayout/academic" className=" link-primary text-decoration-none opacity-50">4- ACADEMICS</Link></b> 
                                </span>
