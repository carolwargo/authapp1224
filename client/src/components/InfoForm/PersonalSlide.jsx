    ...
    <MDBRow className="form-text-header-black d-flex align-items-center mb-3">
                        <MDBCol className="col-sm-12 col-md-12 col-lg-12 justify-content-end">
                            <p className='fw-bold' style={{fontSize:'12px'}}>
                                                        <span className="fw-bold form-text-header-black" style={{marginLeft:'8px'}}> 
                                                           ...
                                                           <span className="text-primary" style={{marginLeft:'8px'}}>
                                                                                                <b className=" opacity-50" style={{  textShadow: '4px 4px 10px rgba(0, 0, 0, 0.5)'}}>  
                                                                                                   <i className=" fas fa-check text-primary"></i> <Link to="/infolayout/contact" className="link-primary text-decoration-none"> CONTACT</Link></b>     
                                                                                       </span> 
                                                        
                                               <span className="fw-bold form-text-header-black" style={{marginLeft:'10px'}}> 
                                                <b><Link to="/infolayout/personal" className=" link-primary text-decoration-none fw-bold">
                                               2- PERSONAL</Link></b>  
                                               </span>
                                               ...
                                               <span className="fw-bold form-text-header-black" style={{marginLeft:'10px'}}> 
                                                <b ><Link to="/infolayout/academics" className=" link-primary text-decoration-none opacity-50">
                                                4- ACADEMICS</Link></b>  
                                               </span>
                                                        </p>
                        </MDBCol>
